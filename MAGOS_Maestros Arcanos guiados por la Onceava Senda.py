...
def nombrar_Jugador():
    ...
    player1 = Jugador(idJugador,nombre_Usuario,elemento_Jugador,20,5,5,5,5,0)
...
player1.subir_Nivel()
rival1 = Rival(1,"rival1","Agua",20,5,5,5,5,1)
jefe1 = Jefe(1,"jefeprueba","Neutral",20,5,5,5,5,10)
